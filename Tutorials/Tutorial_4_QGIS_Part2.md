...
8. **Right-Click** in on the stateboundaries_pop layer, **select** Save As. 
9. Select Save only selected features, and save the shapefile as selectedlayers.shp. This will then be added to our map as a new layer. 
